    ...
    public class MultimediaTimer : IDisposable, ITimer
    {
        ...
        public TimeSpan Interval
        {
            ...
            set
            {
                ...
                if (Resolution > Interval.Milliseconds)
                    Resolution = value.Milliseconds;
            }
        }
        ...
        public void Start()
        {
            ...
            UInt32 userCtx = 0;
            timerId = NativeMethods.TimeSetEvent((uint)Interval.Milliseconds, (uint)Resolution, Callback, ref userCtx, 1);
            if (timerId == 0)
            {
